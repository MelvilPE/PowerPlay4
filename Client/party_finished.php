<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/powerplay4'.'/Server/Fetch/get_winner_name_from_party_id.php';
...
<body>
    <div class="container center-items">
        <div class="alert alert-info" role="alert">This party is finished! Winner is: <?=$winner_name?>
            <br>
            <a class="btn btn-primary w-100" href="<?=$GLOBAL_RELOCATION_START?>/Client/index.php" role="button">Play another party!</a>
        </div>
    </div>
